								...
								<legend>Booking Info.&nbsp;</legend>
									<div class="table-responsive">
							         ...
							         <table id="allocatedReport" class="table table-striped table-bordered table-hover">
							           ...
							           <tr>
							           <td colspan="3" >  <form action="details.action"><input type="text" name="whereh" class="form-control"  placeholder="Search_By_WareHouse" id="Search_By_WareHouse"/>  </td>
							           <td><input type="submit" value="Submit" class="btn btn-primary"/></form></td>
							            <td colspan="3"><form action="datedetails.action"><input type="text" name="mydate" class="form-control"  placeholder="Search_By_Date" /></td><td><input type="submit" value="Submit" class="btn btn-primary"/></form></td>
							           </tr>
