        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown report">
              <a href="trans" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Transportation <span class="caret"></span></a>
              <ul class="dropdown-menu">
               
                 <li data-id="Room Info" class="btn-click"><a href="trans">Tranction</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li data-id="Room Info" class="btn-click"><a href="update">UpdateReport</a></li>
                 <li data-id="Room Info" class="btn-click"><a href="sellproduct">SellPrduct</a></li>
